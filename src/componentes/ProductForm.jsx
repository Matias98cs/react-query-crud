  ...
  return (
    <form onSubmit={handleSubmit} className="my-5 flex gap-5 py-5 bg-orange-100 text-black flex-col w-1/4 rounded-lg">
        <div className='flex w-full self-start flex-col justify-center items-center'>
            <label className='text-xl font-bold px-1 uppercase' htmlFor="name">Nombre</label>
            <input className='text-black py-0.5 w-1/2 rounded-lg shadow-sm' type="text" id='name'  name='name'/>
        </div>

        <div className='flex w-full self-start flex-col justify-center items-center'>
            <label className='text-xl font-bold px-1 uppercase'  htmlFor="description">Description</label>
            <input className='text-black py-0.5 w-1/2 rounded-lg shadow-sm' type="text" id='description' name='description' />
        </div>
        
        <div className='flex w-full self-start flex-col justify-center items-center'>
            <label className='text-xl font-bold px-1 uppercase'  htmlFor="price">Price</label>
            <input  className='text-black py-0.5 w-1/2 rounded-lg shadow-sm' type="number" id='price' name='price' />
        </div>
